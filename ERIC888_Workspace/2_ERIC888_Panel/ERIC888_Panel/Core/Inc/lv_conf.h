...
/*====================
   MEMORY SETTINGS
 *====================*/
/* Use SDRAM for LVGL internal memory (after draw buffers) */
#define LV_MEM_CUSTOM      0
#define LV_MEM_SIZE         (48U * 1024U)   /* 48KB for LVGL heap (in internal RAM) */
#define LV_MEM_ADR          0               /* Use internal allocator */
...
#define LV_USE_METER       1   /* Gauge for voltage/current */
#define LV_USE_MSGBOX      1
#define LV_USE_SPAN        1
#define LV_USE_SPINBOX     1
#define LV_USE_SPINNER     1
#define LV_USE_TABVIEW     1   /* Tab navigation */
...
#define LV_BUILD_EXAMPLES  0   /* Don't build examples */
