...
void MX_SPI4_Init(void)
{
  ...
  /* v3.0 Industrial fix: switch to 8-bit mode + software NSS */
  /* 8-bit mode eliminates 16-bit struct alignment trap */
  /* Software NSS is immune to EMI false triggers on long backplane traces */
