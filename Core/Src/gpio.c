...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, TRIG_OFF_2_Pin|TRIG_ON_1_Pin|TRIG_OFF_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : TRIG_ON_4_Pin */
  GPIO_InitStruct.Pin = TRIG_ON_4_Pin;
  ...
  /*Configure GPIO pins : TRIG_OFF_2_Pin TRIG_ON_1_Pin TRIG_OFF_1_Pin */
  GPIO_InitStruct.Pin = TRIG_OFF_2_Pin|TRIG_ON_1_Pin|TRIG_OFF_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : TRIG_ON_1I4_Pin TRIG_OFF_3_Pin TRIG_ON_3_Pin TRIG_OFF_4_Pin */
  GPIO_InitStruct.Pin = TRIG_ON_1I4_Pin|TRIG_OFF_3_Pin|TRIG_ON_3_Pin|TRIG_OFF_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOI, &GPIO_InitStruct);
