...
void MX_FMC_Init(void)
{
  ...
  */
  ...
  /* Optimize NE4 (AD7606) FMC read timing for 25.6kHz */
  /* AD7606: tACC<=21ns, tREAD>=20ns. HCLK=180MHz, 1tick=5.56ns */
  {
    FMC_NORSRAM_TimingTypeDef AdTiming = {0};
    AdTiming.AddressSetupTime  = 1;   /* 5.56ns */
    AdTiming.AddressHoldTime   = 1;   /* min */
    AdTiming.DataSetupTime     = 4;   /* 22ns >= tREAD 20ns */
    AdTiming.BusTurnAroundDuration = 2; /* bus clash guard */
    AdTiming.CLKDivision       = 2;
    AdTiming.DataLatency       = 2;
    AdTiming.AccessMode        = FMC_ACCESS_MODE_A;
    FMC_NORSRAM_Timing_Init(hsram4.Instance, &AdTiming, hsram4.Init.NSBank);
  }
